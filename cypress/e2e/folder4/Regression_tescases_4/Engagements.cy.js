...
describe('Engagements scoring Login', () => {
  ...
  it('Engagements Custom Events', () => {
    ...
    methods.typeElement(locators.Select_Event, 'Account State Change')
    methods.clickElement(locators.Account_State_Change)
    ...
    methods.EnterXpath(`//textarea[contains(text(),"${testName}")]`)
    ...
    cy.wait(Timeout.sm)
    methods.VisibilityofElementXpath(`//td[text()='${testName}']`)
    ...
    cy.wait(Timeout.sm)
    methods.VisibilityofElementXpath(`//td[text()='${testName1}']`)
    ...
    cy.wait(Timeout.sm)
    methods.VisibilityofElementXpath(`//td[text()='${testName2}']`)
  ...
  it('Engagements scoring Popup verification', () => {
    ...
    cy.wait(Timeout.sm)
    methods.typeElementwithIndex(locators.Search, "https://staging-app.factors.ai/explain", 1)
    cy.wait(Timeout.sm)
    methods.clickElement(locators.Staging_app_factors)
    cy.wait(Timeout.sm)
    methods.clickElementByXPath(locators.custom_event_name)
