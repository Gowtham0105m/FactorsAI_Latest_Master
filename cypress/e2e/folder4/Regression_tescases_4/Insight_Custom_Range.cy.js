...
describe('Insight custom range', () => {
    ...
    it('Insight custom range', () => {
        ...
        cy.wait(Timeout.xmd)
        methods.VisibilityofElement(locators.Select_Analysis_Window)
        methods.clickElement(locators.Select_Analysis_Window)
        methods.clickElementByXPath(locators.Last_Week)
        cy.wait(Timeout.lgr)
        cy.xpath(`//div[contains(@class,"ant-skeleton-element")]`, { timeout: 350000 }).should('not.exist');
        ...
        cy.wait(Timeout.sm)
        methods.clickElementByXPath(locators.previewMonth_New)
