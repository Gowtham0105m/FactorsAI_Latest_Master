...
describe('WorkFlow - SmartLead Login', () => {
    ...
    it.skip('WorkFlow - SmartLead', () => {
        ...
        methods.clickElementByXPath(locators.Smartlead)
        methods.clickElementByXPath(locators.SmartLead_Template)
        methods.clickElementByXPath(locators.Use_this_template)
        methods.clickElement(locators.Edit_Button)
        methods.ClearAndTypeWithXpath(`//textarea[text()="Add leads to a Smartlead campaign"]`, testName);
        ...
        methods.clickElementByXPath(locators.Configure_Action)
        cy.wait(Timeout.sm)
        methods.assertElementContainsTextxpath(`(//*[text()="${IntegrateName}"]//following::*)[1]`, "Connected")
        cy.wait(Timeout.xs)
        methods.clickElement(locators.smartlead_campaign_id)
        cy.wait(Timeout.sm)
        methods.typeElement(locators.smartlead_campaign_id, "Naveena")
        methods.clickElement0(locators.Add_Contacts, 1)
