...
describe('WorkFlow Login', () => {
    ...
    it('WorkFlow - Hubspot', () => {
        ...
        methods.clickElementByXPath(locators.Configure_Action)
        cy.wait(Timeout.md)
        methods.VisibilityofElementXpath(`//*[text()="Map properties from Factors to ${IntegrateName}"]`)
        ...
        cy.wait(Timeout.xs)
        methods.scrollWithXpath(`//*[text()="Map properties from Factors to ${IntegrateName}"]`)
        methods.VisibilityofElementXpath(`//*[text()="Map properties from Factors to ${IntegrateName}"]`)
    ...
    it('WorkFlow - Zoho', () => {
        ...
        methods.clickElementByXPath(locators.Configure_Action)
        cy.wait(Timeout.lg)
        methods.assertElementContainsText1(`(//span[text()="${IntegrateName}"]//following::*)[1]`, "Connected")
        cy.wait(Timeout.xs)
        ...
        methods.typeElementByXPath(locators.Select_Property, "Company Name")
        ...
        methods.typeElementByXPath(locators.Select_Property2, "Company Tech")
    ...
    it('WorkFlow - Activity log', () => {
        ...
        cy.document().then((doc) => {
            ...
            if (noDataElement) {
                ...
                cy.xpath('//*[text()="Activity Log"]//following::tbody/tr[1]/td[3]/*')
                    .invoke('text')
                    .then((DomainName) => {
