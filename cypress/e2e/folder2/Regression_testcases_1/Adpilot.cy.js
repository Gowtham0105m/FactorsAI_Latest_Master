...
describe('Adpilot Smart reach', () => {
    ...
    it('Adpilot Smart reach Campaign - To Add , Edit Rule , Publish Rule and Delete Rule', () => {
        ...
        cy.wait(Timeout.sm)
        methods.assertElementContainsTextxpath(`//*[text()="${new_campaign}"]//following::td[1]`, "Active")
        methods.VisibilityofElementXpath(`//*[text()="${new_campaign}"]`)
        ...
        methods.clickElement(locators.Add_Filters_value1)
        ...
        methods.assertElementContainsText(locators.notification_popup, "SuccessRule Successfully Updated!", {timeout:6000})
        methods.clickElementByXPath(locators.adpilot_arrow_left)
        cy.wait(Timeout.sm)
        methods.VisibilityofElementXpath(`//*[text()="${new_campaign1}"]`)
        methods.assertElementContainsTextxpath(`//*[text()="${new_campaign1}"]//following::td[1]`, "Active")
        cy.wait(Timeout.xs)
        methods.VisibilityofElementXpath(`//*[text()="${new_campaign1}"]`)
        methods.clickElementByXPath(`//*[text()="${new_campaign1}"]//following::button[1]`)
    ...
    it('Adpilot Smart reach All ad accounts - To Add , Edit Rule , Publish Rule, and delete Rule', () => {
        ...
        methods.clickElementByXPath(locators.adpilot_arrow_left)
        cy.wait(Timeout.sm)
        methods.VisibilityofElementXpath(`//*[text()="${Add_campaign}"]`)
        ...
        methods.clickElementByXPath(locators.adpilot_arrow_left)
        cy.wait(Timeout.sm)
        methods.VisibilityofElementXpath(`//*[text()="${Add_campaign1}"]`)
        methods.assertElementContainsTextxpath(`//*[text()="${Add_campaign1}"]//following::td[1]`, "Active")
        cy.wait(Timeout.xs)
        methods.VisibilityofElementXpath(`//*[text()="${Add_campaign1}"]`)
        methods.clickElementByXPath(`//*[text()="${Add_campaign1}"]//following::button[1]`)
        methods.clickElementByXPath(locators.Remove_rule)
        cy.wait(Timeout.xs)
        methods.clickElementByXPath(locators.Ok)
        methods.assertElementContainsText(locators.notification_popup, "SuccessRule Successfully Deleted!")
    ...
    it('Adpilot Smart reach To verify whether the pause functionality is working has expected', () => {
        ...
        cy.wait(Timeout.xs)
        methods.VisibilityofElementXpath(`//*[text()="${new_campaign}"]`)
        methods.assertElementContainsText1(`//*[text()="${new_campaign}"]//following::span[1]`, "Paused")
        cy.wait(Timeout.md)
        methods.VisibilityofElementXpath(locators.SmartReach)
        cy.wait(Timeout.sm)
        cy.xpath(`//*[text()="${new_campaign}"]`, { timeout: extraTimeOut }).click({ force: true })
        cy.wait(Timeout.xs)
        ...
        methods.clickElementByXPath(locators.adpilot_arrow_left)
        methods.VisibilityofElementXpath(`//*[text()="${new_campaign}"]`)
        methods.assertElementContainsText1(`//*[text()="${new_campaign}"]//following::span[1]`, "Active")
        cy.wait(Timeout.xs)
        methods.VisibilityofElementXpath(`//*[text()="${new_campaign}"]`)
        methods.clickElementByXPath(`//*[text()="${new_campaign}"]`)
        cy.wait(Timeout.sm)
    ...
    it('Adpilot Smart Reach - View Activity Logs', () => {
        ...
        methods.VisibilityofElementXpath(`//*[text()="${new_campaign}"]`)
        methods.assertElementContainsTextxpath(`//*[text()="${new_campaign}"]//following::td[1]`, "Active")
        methods.clickElementByXPath(`//*[text()="${new_campaign}"]//following::button[1]`)
