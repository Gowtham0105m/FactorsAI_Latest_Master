...
describe('Global search funnel', () => {
    ...
    it('Global search funnel without saving', () => {
        ...
        methods.ClickandType(locators.Search_or_jump, 'New Funnel Report');
        methods.clickElementByXPath(locators.Create_New_Funnel_Report);
    ...
    it('Global search funnel with saving', () => {
