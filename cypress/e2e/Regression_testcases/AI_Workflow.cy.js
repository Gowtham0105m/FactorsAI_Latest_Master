...
describe('AI Workflow', () => {
    ...
    it('AI Workflow', () => {
        ...
        const testName = `Demo AI Workflow_${nowTime}`;
        const testName1 = `Demo AI Workflow New_${nowTime}_1`;
        ...
        cy.wait(Timeout.xs)
        methods.clickElementByXPath(locators.AI_Workflows)
        methods.ElementToBeClickableXpath(locators.AI_Workflows)
        methods.clickElementByXPath(locators.Get_relevant_contacts)
        ...
        methods.clickElementIndexXpath(locators.View_Agent, 0)
        cy.wait(Timeout.md)
        methods.assertElementContainsTextWithIndex(locators.Detailed_View, 'Detailed View', 0)
