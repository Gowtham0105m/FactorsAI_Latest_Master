...
describe('Account Template Login', () => {
    ...
    it('Account Template', () => {
        ...
        cy.wait(Timeout.sm)
        methods.typeElementByXPath(locators.Search_Input, "Source")
        methods.clickElement0(locators.Enrichment_Source, 0)
        methods.clickElement(locators.containsOpt)
        cy.wait(Timeout.sm)
        methods.typeElementByXPath(locators.Source_Input, "Not set")
        methods.EnterXpath(locators.Source_Input)
        cy.wait(Timeout.sm)
