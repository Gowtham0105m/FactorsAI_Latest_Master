class locators {
  ...
  constructor() {
    ...
    this.all_People_Title = '//h3[text()="All People"]';
    ...
    this.QuickSearchTitle = '//span[text()="Quick suggestions"]//following::div[4]';
    ...
    this.Intent_Upload = '//div[text()="Intent Upload"]';
    this.IntentPageLoaded = '//div[contains(@id,"panel-intentUpload")]';
    ...
    this.HeyReach_Template = '//h4[text()="Add leads to a HeyReach list"]';
    ...
    this.Heyreach_campaign = '//h4[text()="Add leads to a HeyReach campaign"]';
    ...
    this.PredictiveScoring = '//div[text()="Predictive Scoring"]';
    ...
    this.search_button1 = "(//div[contains(@id,'panel-hiddenAccounts')]//button)[3]";
    ...
    this.Sharing = '//h4[text()="Sharing"]';
    this.Segment_Digest = '//div[text()="Segment Digest"]';
